        ...
        <form class="af-form" @submit.prevent="onLogin">
          <div class="af-field">
            ...
            <input
              v-model="accountCode"
              type="text"
              :placeholder="t('JABVOX_AFFILIATE_PORTAL.ACCOUNT_CODE_PLACEHOLDER')"
          ...
          <div class="af-field">
            ...
            <div class="af-pass-wrap">
              ...
              />
              <button type="button" class="af-eye" @click="showPassword = !showPassword">
...
@media (min-width: 1024px) { .af-left { display: flex; } }
.af-left-bg { display: none; }
.af-left-content { position: relative; z-index: 1; text-align: center; }
.af-left-title {
  font-size: 2.75rem;
  font-weight: 300;
  line-height: 1.25;
...
.af-left-title span { color: #15605A; }
.af-left-subtitle {
  font-size: 1rem;
  font-weight: 300;
  color: #24292D;
...
.af-input-pass { padding-right: 3rem; }
.af-eye {
  position: absolute;
  right: 0.75rem;
  top: 50%;
...
.af-btn:hover { background: #40B5B4; }
